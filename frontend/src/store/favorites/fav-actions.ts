...
import { favActions, FavoritesType } from './fav-slice';

const updateFav = async (fav: FavoritesType, csrfToken: string) => {
...
export function sendFavData(fav: FavoritesType, csrfToken: string) {
