...
const handleDuplicateFieldsDB = (err: { keyValue: { [key: string]: any } }) => {
    const { keyValue } = err;
...
const handleValidationErrorDB = (err: { errors: { [key: string]: any } | ArrayLike<any> }) => {
...
// MANAGE PRODUCTION AND DEV ERRORS
/////////////////////////////////////////////////////////////////
